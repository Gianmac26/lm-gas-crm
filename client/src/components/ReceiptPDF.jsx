...
const styles = StyleSheet.create({
  ...
  tableHeaderRow: {
    flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: BORDER, paddingBottom: 5, marginBottom: 2,
  },
  tableRow: {
    flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: BORDER, paddingVertical: 5,
  },
